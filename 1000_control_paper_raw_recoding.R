...
setwd("//192.168.0.17/stash_sna/Data/AnonymisedData/baseline_Schools")
########################
# Lockdown directory
raw.sch.listB[[2]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
raw.sch.listB[[2]]$respondent_school <- 2

raw.sch.listB[[5]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
raw.sch.listB[[5]]$respondent_school <- 5

raw.sch.listB[[3]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
raw.sch.listB[[3]]$respondent_school <- 3

raw.sch.listB[[1]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
raw.sch.listB[[1]]$respondent_school <- 1

raw.sch.listB[[4]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
raw.sch.listB[[4]]$respondent_school <- 4

raw.sch.listB[[6]] <- read.csv("REDACTED, stringsAsFactors = FALSE)
raw.sch.listB[[6]]$respondent_school <- 6


####Control Schools
raw.sch.listC <- list()
setwd("//130.209.141.254/stash_sna/Data/AnonymisedData/Control_Schools")

raw.sch.listC[[2]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
raw.sch.listC[[2]]$respondent_school <- 2

raw.sch.listC[[5]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
raw.sch.listC[[5]]$respondent_school <- 5

raw.sch.listC[[3]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
raw.sch.listC[[3]]$respondent_school <- 3

raw.sch.listC[[1]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
raw.sch.listC[[1]]$respondent_school <- 1

raw.sch.listC[[4]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
raw.sch.listC[[4]]$respondent_school <- 4

raw.sch.listC[[6]] <- read.csv("REDACTED", stringsAsFactors = FALSE)
