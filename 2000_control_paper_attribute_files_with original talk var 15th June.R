...
#load("//med2023.campus.gla.ac.uk/stash_sna/Data/AnonymisedData/working data/recoded_baseline.rdata")
#load("//med2023.campus.gla.ac.uk/stash_sna/Data/AnonymisedData/working data/recoded_control.rdata")
...
baseline.attributes <- full.att[full.att$base==1,1:12]
control.attributes <- full.att[full.att$base==0,1:12]
...
#colnames(control.attributes.with.raw)
#cnames <-  colnames(baseline.attributes.with.raw)

############## # #  # # # # #Need to fix this up, differing column names
#control.attributes.with.raw <- control.attributes.with.raw[,cnames]


#full.att <- rbind(baseline.attributes.with.raw, control.attributes.with.raw)
#full.att$std.know <- scale(full.att$know.var)
#full.att$std.att  <- scale(full.att$att.var)
#full.att$std.conf <- scale(full.att$conf.var)#
