...
save(ergm.data.control.imputed, file = "//192.168.0.17/stash_sna/Data/AnonymisedData/working data/ergm_data_control_imputed_5501.rdata")
save(ergm.data.baseline.imputed, file = "//192.168.0.17/stash_sna/Data/AnonymisedData/working data/ergm_data_baseline_imputed_5501.rdata")
